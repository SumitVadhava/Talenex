...
//    {
//        protected Repository<User> _repo;
...
//        public async Task<User?> RegisterOrLoginUser(String clerkUserId, string email, string firstName, string lastName, string imageUrl, DateTime createdAt, DateTime? lastLoginAt)
//        {
//            var user = await _table.FirstOrDefaultAsync(u => u.ClerkUserId == clerkUserId);

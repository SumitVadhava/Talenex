/**
 * This function takes the image source and the crop area and returns a blob of the cropped image.
 * @param {string} imageSrc - The source of the image to crop.
 * @param {Object} pixelCrop - The area to crop (x, y, width, height in pixels).

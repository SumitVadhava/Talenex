    ...
    return (
        <div className="relative min-h-screen bg-transparent flex flex-col items-center justify-center p-8">
            ...
            <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center overflow-hidden pointer-events-none z-0">
                <h1
                    className={`text-[20vw] font-bold text-gray-100 select-none transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                        }`}
                    style={{ lineHeight: '1' }}
                >
                    Talenex
            ...
            <footer className="relative z-10 w-full max-w-6xl">
                <div
                    className={`grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                        }`}
                >
                    {/* Logo Column */}
                ...
                {/* Bottom Bar */}
                <div
                    className={`pt-8 border-t border-gray-200 transition-all duration-700 delay-700 ${isVisible ? 'opacity-100' : 'opacity-0'
                        }`}
                >

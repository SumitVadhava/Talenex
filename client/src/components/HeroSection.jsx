...
const FloatingParticle = () => {
    ...
    useEffect(() => {
        ...
        setTimeout(moveParticle, Math.random() * 1000)
    }, [y])
        ...
        >
            ...
            <motion.div style={{ y, opacity }} className="relative pt-32 pb-16 px-4">
                <div className="max-w-7xl mx-auto flex flex-col items-center justify-center">
                    <div className="group relative mx-auto mb-4 inline-flex items-center justify-center gap-2 rounded-full bg-neutral-100/50 px-4 py-2 shadow-[inset_0_-8px_10px_#8fdfff1f] backdrop-blur-sm transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f] dark:bg-black/40 dark:border-white/10">
                        <span
                            className={cn(
                                "animate-gradient absolute inset-0 h-full w-full rounded-[inherit] bg-gradient-to-r from-[#ffaa40]/50 via-[#9c40ff]/50 to-[#ffaa40]/50 bg-[length:300%_100%] p-[1px]"
                            )}
                            style={{
                                WebkitMask:
                    ...
                    >
                        <h1 className="text-7xl md:text-8xl font-bold mb-6 tracking-tight relative">
                            ...
                            <motion.span
                                className="absolute -inset-1 bg-primary/20 rounded-full blur-3xl"
                                initial={{ opacity: 0 }}
                        ...
                        {stats.map((stat, index) => (
                            ...
                            >
                                <motion.div
                                    ...
                                    className="bg-card/50 rounded-xl p-6 backdrop-blur-sm border border-border transition-colors hover:border-primary/50 shadow-sm"
                                >

                ...
                {[
                  {
                    ...
                    value: userData.reputation?.totalswapsCompleted || 0,
                    color: "text-blue-600",
                    bg: "bg-blue-100",
                  },
                  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="shadow-sm border-slate-200 gap-0">
            ...
            <CardContent className="h-full">
              {userData.reputation?.totalSwapsCompleted > 0 ? (
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4">
                  {[
                    ...
                    const isEarned = userData.reputation?.totalSwapsCompleted >= badge.threshold;
                    return (
                      <div
                        key={i}
